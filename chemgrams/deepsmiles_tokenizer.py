...
class DeepSMILESTokenizer:
    ...
    [H]
    B, b, [B-], [B]
    C, c, [C@@H], [C@H], [C@], [C@@], [CH2-], [CH-], [C]
    O, o, [o+], [O-], [OH+], [O+], [OH2], [O],
    N, n, [NH+], [nH], [NH3+], [NH2+], [N-], [n+], [NH-], [N+], [nH+], [n-], [NH4+], [N]
    S, s, [S@], [S@@], [S-], [S+],[SH+], [s+], [S@@+], [S@+], [S]
    P, p, [P@@H], [P@@], [PH2], [P@], [P@H], [P@H+], [P+], [PH+], [PH], [P@@H+], [P]
    F, Cl, Br, I, [F], [Cl], [Br], [I]
    ...
    def _tokenize(self):
        ...
        formal_atoms = ("[H]", "[B-]", "[B]", "[C@@H]", "[C@H]", "[C@]", "[C@@]", "[CH2-]", "[CH-]", "[C]",
                        "[o+]", "[O-]", "[OH+]", "[O+]", "[OH2]", "[O]",
                        "[NH+]", "[nH]", "[NH3+]", "[NH2+]", "[N-]", "[n+]", "[NH-]", "[N+]", "[nH+]", "[n-]", "[NH4+]", "[N]",
                        "[S@]", "[S@@]", "[S-]", "[S+]", "[SH+]", "[s+]", "[S@@+]", "[S@+]", "[S]",
                        "[P@@]", "[P@@H]", "[P@@H+]", "[P@]", "[P@H]", "[P@H+]", "[P+]", "[PH]", "[PH+]", "[PH2]", "[P]",
                        "[F]", "[Cl]", "[Br]", "[I]")
        escaped = ()
