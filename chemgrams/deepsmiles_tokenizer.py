...
class DeepSMILESTokenizer:
    ...
    Atoms:
    [H]
    B, b, [B-], [B], [BH-], [BH], [B@-], [B@@-], [BH3-], [b-]
    C, c, [C@@H], [C@H], [C@], [C@@], [CH2-], [CH-], [C], [C+], [C-], [c], [c-], [CH+], [CH], [CH2+], [CH2], [C@H-], [cH-]
    O, o, [o+], [O-], [OH+], [O+], [OH2], [O], [OH]
    N, n, [NH+], [nH], [NH3+], [NH2+], [N-], [n+], [NH-], [N+], [nH+], [n-], [NH4+], [N], [N@@+], [N@+], [N@@H+], [N@H+]
    S, s, [S@], [S@@], [S-], [S+],[SH+], [s+], [S@@+], [S@+], [S], [SH-], [s@@], [S@H], [S@@H]
    P, p, [P@@H], [P@@], [PH2], [P@], [P@H], [P@H+], [P+], [PH+], [PH], [P@@H+], [P], [P@@+], [PH2+], [P@+], [pH]
    F, Cl, Br, I, [F], [Cl], [Br], [I], [IH], [IH2], [I+]
    ...
    def _tokenize(self):
        ...
        formal_atoms = ("[H]", "[B-]", "[B]", "[C@@H]", "[C@H]", "[C@]", "[C@@]", "[CH2-]", "[CH-]", "[C]", "[C+]", "[C-]", "[c-]", "[C@H-]", "[cH-]",
                        "[o+]", "[O-]", "[OH+]", "[O+]", "[OH2]", "[O]", "[N@@+]", "[N@+]", "[N@@H+]", "[c]", "[BH-]", "[CH+]", "[CH]", "[b-]",
                        "[NH+]", "[nH]", "[NH3+]", "[NH2+]", "[N-]", "[n+]", "[NH-]", "[N+]", "[nH+]", "[n-]", "[NH4+]", "[N]", "[N@H+]",
                        "[S@]", "[S@@]", "[S-]", "[S+]", "[SH+]", "[s+]", "[S@@+]", "[S@+]", "[S]", "[SH-]", "[s@@]", "[OH]", "[CH2]", "[I+]",
                        "[P@@]", "[P@@H]", "[P@@H+]", "[P@]", "[P@H]", "[P@H+]", "[P+]", "[PH]", "[PH+]", "[PH2]", "[P]", "[PH2+]", "[pH]", "[IH2]",
