...
class DeepSMILESTokenizer:
    ...
    C, c, [C@@H], [C@H], [C@], [C@@], [CH2-], [CH-], [C], [C+], [C-], [c], [CH+], [CH], [CH2+], [CH2]
    O, o, [o+], [O-], [OH+], [O+], [OH2], [O], [OH]
    N, n, [NH+], [nH], [NH3+], [NH2+], [N-], [n+], [NH-], [N+], [nH+], [n-], [NH4+], [N], [N@@+], [N@+]
    S, s, [S@], [S@@], [S-], [S+],[SH+], [s+], [S@@+], [S@+], [S], [SH-]
    ...
    def _tokenize(self):
        ...
        formal_atoms = ("[H]", "[B-]", "[B]", "[C@@H]", "[C@H]", "[C@]", "[C@@]", "[CH2-]", "[CH-]", "[C]", "[C+]", "[C-]",
                        "[o+]", "[O-]", "[OH+]", "[O+]", "[OH2]", "[O]", "[N@@+]", "[N@+]", "[c]", "[BH-]", "[CH+]", "[CH]",
                        "[NH+]", "[nH]", "[NH3+]", "[NH2+]", "[N-]", "[n+]", "[NH-]", "[N+]", "[nH+]", "[n-]", "[NH4+]", "[N]",
                        "[S@]", "[S@@]", "[S-]", "[S+]", "[SH+]", "[s+]", "[S@@+]", "[S@+]", "[S]", "[SH-]", "[OH]", "[CH2]",
                        "[P@@]", "[P@@H]", "[P@@H+]", "[P@]", "[P@H]", "[P@H+]", "[P+]", "[PH]", "[PH+]", "[PH2]", "[P]", "[PH2+]",
                        "[F]", "[Cl]", "[Br]", "[I]", "[P@@+]", "[P@+]", "[BH]", "[B@-]", "[B@@-]", "[BH3-]", "[CH2+]")
        escaped = ()
