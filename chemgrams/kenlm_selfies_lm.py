...
class KenLMSELFIESLanguageModel(ChemgramsLanguageModel):
        ...
        for s in split:
            if s != '' and s is not None:
                if s == "<s>" or s == "</s>":
                    ...
                    tokens.extend(self._tokenize_selfies(s))
        return tokens
    ...
    def log_prob(self, sentence):
        ...
        :param sentence: a string in KenLM format, not including start and end tokens, e.g. "[N] [C] [C] [O]"
