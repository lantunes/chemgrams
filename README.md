...
The table below summarizes the results of comparing a 6-gram language
model based on SMILES syntax to a 6-gram language model based on DeepSMILES
...
attained, probably because more valid and unique molecules are generated
