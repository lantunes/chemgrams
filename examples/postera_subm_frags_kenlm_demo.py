...
with open("../models/postera-covid-submissions-2020-03-27.txt") as f:
...
for i in range(100000):
    try:
        ...
        all_smiles[sanitized] = (qedscore, generated)

        mol_props[sanitized] = (qedscore, mean_distance, max_similarity, Chem.MolToSmiles(most_similar_submission_mol))
