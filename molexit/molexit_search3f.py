...
logger.info("keep_top_n = 50000 along with original fragment dataset")
...
for n in range(num_iterations):
    ...
    logger.info("writing dataset along with original fragment dataset...")
    with open("../resources/zinc12_fragments_deepsmiles_corpus_kenlm.txt", 'r') as orig:
