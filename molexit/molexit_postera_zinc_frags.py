...
logger.info("KenLMDeepSMILESLanguageModel(n=6, 'zinc12_fragments_deepsmiles_klm_6gram_190421.klm')")
logger.info("width = 12, max_depth = 45, start_state = ['<s>'], c = 5")
...
for n in range(num_iterations):
    ...
    def eval_function(text):
        ...
        try:
            ...
            if sanitized in sanitized_to_final:
