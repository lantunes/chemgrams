...
setup(name="chemgrams",
      ...
      packages=["chemgrams", "chemgrams.jscorer", "chemgrams.sascorer", "chemgrams.qedscorer", "chemgrams.logger", "chemgrams.tanimotoscorer"],
      package_data={'chemgrams.sascorer': ['fpscores.pkl.gz']},
